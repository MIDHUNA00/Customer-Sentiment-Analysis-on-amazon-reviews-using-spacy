...
URL = "https://www.amazon.in/Jixing-Strings-Acoustic-Guitars-Black/product-reviews/B00V5ZCVQA/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewer"


pages = 10

# Create a CSV file to store the data
with open('reviewset2.csv', 'w', encoding="utf-8", newline='') as file:
...
import pandas as pd
data = pd.read_csv('reviewset2.csv')
print(data)
print(data.head(5))
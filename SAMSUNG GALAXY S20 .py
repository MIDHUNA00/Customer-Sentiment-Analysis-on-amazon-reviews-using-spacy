...
URL = "https://www.amazon.in/Samsung-Galaxy-Cloud-Lavender-Storage/product-reviews/B08V9VMRQF/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews"

pages = 10

# Create a CSV file to store the data
with open('reviewset.csv', 'w', encoding="utf-8", newline='') as file:
...
import pandas as pd
data = pd.read_csv('reviewset.csv')
print(data)
print(data.head(5))